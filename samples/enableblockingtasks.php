...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php enableblockingtasks.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 // enable the default blocking task operations set by this sample\n";
    echo "     # php enableblockingtasks.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -c certificatepath// enable the default blocking task operations set by this sample\n";
