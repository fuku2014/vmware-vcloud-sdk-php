...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php createnetpool.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b pool -c network-19\n";
    echo "     # php createnetpool.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b pool -c network-19 -d certificatepath\n";
