...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php uploadvapptemplate.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b vdc -c catalog -d=vapptemp -e 'E:/ovf/dsl-with-tools.ovf' -f='vappTemp description' -g='true' ";
    echo "     # php uploadvapptemplate.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b vdc -c catalog -d=vapptemp -e 'E:/ovf/dsl-with-tools.ovf' -f='vappTemp description' -g='true' -h='certificatepath'\n";
