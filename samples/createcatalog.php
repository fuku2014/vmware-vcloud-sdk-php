...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php createcatalog.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b=cat\n";
    echo "     # php createcatalog.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b=cat -c certificatepath\n";
