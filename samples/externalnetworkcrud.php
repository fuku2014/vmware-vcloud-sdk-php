...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php externalnetworkcrud.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b net -c name -d fence\n";
    echo "     # php externalnetworkcrud.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b net -c name -d fence -e certificatepath\n";
