...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php networkpoolcrud.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a portgroup-backed -b vim -c pool -d name -e dvswitch\n";
    echo "     # php networkpoolcrud.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a portgroup-backed -b vim -c pool -d name -e dvswitch -f certificatepath\n";
