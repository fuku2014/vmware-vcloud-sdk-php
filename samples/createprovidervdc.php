...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php createprovidervdc.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b pvdc -c storageprofile -d resgroup-84\n";
    echo "     # php createprovidervdc.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b pvdc -c storageprofile -d resgroup-84 -h certificatepath\n";
    echo "     # php createprovidervdc.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a vim -b pvdc -c storageprofile -d resgroup-84\n";
