...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php callout.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a=10.20.120.140 -g=DefaultOrg -h=vdcUpdateTemplate\n";
    echo "     # php callout.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a=10.20.120.140 -g=DefaultOrg -h=vdcUpdateTemplate -q certificatepath\n";
