...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php createextnet.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a=vim -b=net -c=dvportgroup-37 -d=gw -e=mask -f=dns1 -g=dns2 -h=suffix -i=start -j=end -k=fence\n";
    echo "     # php createextnet.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a=vim -b=net -c=dvportgroup-37 -d=gw -e=mask -f=dns1 -g=dns2 -h=suffix -i=start -j=end -k=fence -m certificatepath\n";
