...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php createcatalogitem.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b=vdc -c catlog -d=vapptemp -e=item -f=description\n";
    echo "     # php createcatalogitem.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b=vdc -c catlog -d=vapptemp -e=item -f=description -h certificatepath\n";
