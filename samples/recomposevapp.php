...
function usage()
{
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php recomposevapp.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b vdc -c vapp -d temp -e vm -f net -g name\n";
    echo "     # php recomposevapp.php -s 127.0.0.1 -u admin@Org -p password -v 5.7 -a org -b vdc -c vapp -d temp -e vm -f net -g name  -h certificatepath\n";
